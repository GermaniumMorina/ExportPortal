      ...
      <div className="container">
        ...
        <table className="table table-striped table-bordered table-hover">
          <thead className="bg-info text-black">
            <tr>
              <th scope="col"> {t("companyListing.Select")}</th>
              <th scope="col">{t("companyListing.Name")}</th>
              <th scope="col">{t("companyListing.Keywords")}</th>
              <th scope="col"> {t("companyListing.Country")}</th>
              <th scope="col"> {t("companyListing.More Info")}</th>
            </tr>
          </thead>
          <tbody>
